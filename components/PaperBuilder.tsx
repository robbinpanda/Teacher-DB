            ...
            <div className="template-studio-body">
              ...
              <div className="template-studio-controls">
                ...
                {studioTab === "type" && <div className="template-studio-panel">
                  ...
                  <div className="template-control-grid"><label><span>粗细</span><select value={paperStyle.sectionTitleWeight} onChange={(event) => patchPaperStyle({ sectionTitleWeight: Number(event.target.value) as PaperStyleConfig["sectionTitleWeight"] })}><option value="400">常规</option><option value="500">中等</option><option value="700">粗体</option></select></label><label><span>大题标题分隔线</span><select value={paperStyle.sectionDivider} onChange={(event) => patchPaperStyle({ sectionDivider: event.target.value as PaperStyleConfig["sectionDivider"] })}><option value="none">无（试卷常用）</option><option value="single">单线</option></select></label></div>
                  ...
                  {paperStyle.sectionDivider === "single" && <MetricControl label="标题分隔线内距" value={paperStyle.sectionHeadingPadding} min={0} max={10} step={0.5} unit="mm" onChange={(sectionHeadingPadding) => patchPaperStyle({ sectionHeadingPadding })} />}
                </div>}
